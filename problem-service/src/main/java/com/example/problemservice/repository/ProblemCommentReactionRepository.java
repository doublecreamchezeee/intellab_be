...
@Repository
public interface ProblemCommentReactionRepository extends JpaRepository<ProblemCommentReaction, ProblemCommentReactionId> {
    ...
    Boolean existsByProblemComment_CommentIdAndReactionId_UserUuidAndIsActive(UUID problemCommentCommentId, UUID reactionIdUserUuid, Boolean isActive);

    Boolean existsByReactionIdAndIsActive(ProblemCommentReactionId reactionId, Boolean isActive);
}

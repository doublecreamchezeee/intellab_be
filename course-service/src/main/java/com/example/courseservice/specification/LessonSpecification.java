...
public class LessonSpecification {
    public static Specification<Lesson> hasProblemId() {
        return (root, query, criteriaBuilder) -> criteriaBuilder.isNotNull(root.get("problemId"));
    }

    public static Specification<Lesson> hasExerciseId() {
        return (root, query, criteriaBuilder) -> criteriaBuilder.isNotNull(root.get("exercise"));
    }
